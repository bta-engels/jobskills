            ...
            <div class="card">
                ...
                <div class="card-body">
                    <x-form method="POST" action="{{ route('register') }}">
                        <x-form-input class="mb-3" name="name" default="{{ old('name') }}" label="{{ __('First- and Lastname') }}" required autocomplete="name" autofocus />
                        ...
                        <x-form-input type="password" class="mb-3" name="password_confirmation" label="{{ __('Password repeat') }}" required autocomplete="new-password" />
